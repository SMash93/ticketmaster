...
INSERT INTO `reservation` VALUES (1,1,'CONFIRMED','madarus',1,''),(2,2,'PRINTED','aaaa',2,''),(3,NULL,'UNCONFIRMED','aaa',1,'');
...
INSERT INTO `seat` VALUES (1,1,3,3,''),(2,2,4,4,'');
...
INSERT INTO `user` VALUES (1,'Madalina','Rus','madarus','mada','CLIENT','madarus','cluj','00000',NULL),(2,'Andrei','Chelu','achelu','andrei','VIEWER','andrei','cluj','00000',NULL),(3,'Lorand','Vaida','lorand','lorand','ADMIN','lorand','clij','00000',NULL),(4,'Noemi','Gaspar','gasparn','noemi','MANAGER','noemi','cluj','0000',NULL),(5,'Vlad','Blaj','vlad','vlad','CASHIER','vlad','cluj','00000',NULL),(6,'Ovidiu','Pop','ovidiu','ovidiu','CLIENT','ovidiu','cluj','00000',NULL);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'ticketmaster'
--

--
-- Dumping routines for database 'ticketmaster'
--
...
-- Dump completed on 2015-09-08  9:21:10
